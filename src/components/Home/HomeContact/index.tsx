      ...
      <div className="container mx-auto max-w-7xl px-4 relative z-10">
        <div className=" mx-auto">
          ...
          <div className="flex flex-col items-center mb-12">
            <h1 className="text-2xl md:text-[28px] font-black leading-[50px] text-white text-center relative pb-4 after:content-[''] after:w-[100px] after:h-[2px] after:bg-white after:bottom-0 after:left-1/2 after:absolute after:-translate-x-1/2">
              {t("title")}
            </h1>
          </div>
